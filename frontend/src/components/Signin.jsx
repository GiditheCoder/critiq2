      ...
      <div className="w-full max-w-[280px] sm:max-w-md">
        ...
        {loading ? (
          <div className="text-center mb-4 sm:mb-6">
            ...
            <Skeleton height={16} width={140} baseColor="#A259FF" highlightColor="#E2CCFF" style={{ opacity: 0.2 }} className="mx-auto sm:!h-5 sm:!w-40" />
          </div>
        ) : (
        ...
        {!loading && (
          <div className={`flex justify-between items-center text-xs sm:text-sm text-gray-400 mb-4 sm:mb-6 transition-opacity duration-700 ease-in-out ${loaded ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <span className="cursor-pointer hover:underline text-white" onClick={handleForgotPasswordScreen}>
              Forgot Password
            </span>
          </div>
        )}
