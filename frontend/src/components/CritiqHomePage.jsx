                ...
                return (
                  <li key={song.id} className="p-4 bg-[#1c1c27] rounded-lg flex items-center justify-between hover:bg-[#232333] hover:shadow-lg hover:scale-[1.02] transition duration-300 ease-in-out">
                    <div className="flex items-center gap-4">
                      {song.cover ? (
                        <img src={song.cover} alt={song.title} className="w-16 h-16 object-cover rounded" />
                      ) : (
...
export default CritiqHomePage;
  ...
  //           </div>
  //           <span className="text-xs text-[#A259FF] font-medium">Browse</span>
  //         </button>
  //         <button className="flex flex-col items-center gap-1 p-2">
  //           <div className="w-8 h-8 flex items-center justify-center">
  //             <Heart className="w-4 h-4 text-gray-400" />
  //           </div>
  //           <span className="text-xs text-gray-400">My Votes</span>
  //         </button>
  //         <button className="flex flex-col items-center gap-1 p-2">
  //           <div className="w-8 h-8 flex items-center justify-center">
