      ...
      <div className="w-full max-w-[280px] sm:max-w-md">
        ...
        {loading ? (
          <div className="text-center mb-4 sm:mb-6">
            ...
            <Skeleton height={16} width={200} baseColor="#A259FF" highlightColor="#E2CCFF" style={{ opacity: 0.2 }} className="mx-auto sm:!h-5 sm:!w-64" />
          </div>
        ) : (
        ...
        {loading ? (
          ...
          <div className={`mb-3 sm:mb-4 transition-opacity duration-700 ease-in-out ${loaded ? 'opacity-100' : 'opacity-0'}`}>
            ...
            <div className="flex items-center bg-transparent border border-[#a7a7a7] px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-md">
